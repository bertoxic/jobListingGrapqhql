...
import (
	...
	"github.com/bertoxic/graphql2/database"
...
// FilterJobs is the resolver for the filterJobs field.
func (r *queryResolver) FilterJobs(ctx context.Context, filter string, field string) ([]*model.JobListing, error) {
	return db.FilterJobs(filter, field)
}
